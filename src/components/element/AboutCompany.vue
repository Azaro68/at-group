        ...
        <div class="description">
            <div class="container">
                ...
                <div class="aboutText">
                    ...
                    <div class="textRight">
                        <p class="mainDescript">Наша команда работает оперативно, обеспечивая быстрые ответы на запросы и минимальные сроки поставки. </p>
                        <p class="descript">Мы находим оптимальные решения, соответствующие вашим техническим и бюджетным требованиям. Понимаем, что время – решающий фактор в современном мире.</p>
                    </div>
